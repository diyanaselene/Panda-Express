...
@onready var race_tutorial   = $FixedScreenInputs/RaceTutorialLabel
...
func _ready() -> void:
	...
	panda.race_speed = GameData.race1_speed
...
func _on_countdown_finished() -> void:
	...
	panda.race_speed    = GameData.race1_speed
	panda.jump_modifier = GameData.race1_jump_modifier
	...
	# Show roll tutorial once
	if not GameData.shown_race_tutorial:
		GameData.shown_race_tutorial = true
		race_tutorial.show()
...
func _end_race() -> void:
	...
	GameData.record_race_result(player_place, 1)
